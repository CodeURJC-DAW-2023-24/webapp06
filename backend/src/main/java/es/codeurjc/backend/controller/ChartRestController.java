...
public class ChartRestController {
    ...
    public String getWeeklyChart(Model model, Principal principal,
    ...
    public String getMonthlyChart(Model model, Principal principal,
            @RequestParam("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date)
            throws JsonProcessingException {
    ...
    public String getAnnuallyChart(Model model, Principal principal,
