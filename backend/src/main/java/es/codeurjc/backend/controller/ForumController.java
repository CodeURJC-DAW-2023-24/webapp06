...
public class ForumController {
    ...
    @GetMapping("/f/{forumName}")
    public String getForum(Model model, Principal principal, @PathVariable String forumName) {
        return "forum";
    }

    @GetMapping("/f/{forumName}/t/{threadName}")
    public String getThread(Model model, Principal principal, @PathVariable String forumName,
        ...
        class PostWithElapsedTime {
            ...
            public PostWithElapsedTime(Post post, Principal principal) {
                ...
                if (principal != null && principal.getName() != null && !principal.getName().isEmpty()) {
                    this.isOwner = (principal.getName().equals(this.username)) || userService.isAdmin(principal.getName());
                }
            }
        }
