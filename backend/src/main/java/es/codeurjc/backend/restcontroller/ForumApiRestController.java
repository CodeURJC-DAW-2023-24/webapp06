...
public class ForumApiRestController {
  ...
  @GetMapping
  @Operation(summary = "Gets all forums", description = "Provides a list of all the forums in the web.", responses = {
  ...
  @GetMapping("/{id}")
  @Operation(summary = "Gets a forum by id", description = "Provides a forum based on the specified id.", responses = {
      @ApiResponse(responseCode = "200", description = "Successful operation", content = @Content(mediaType = "application/json")),
